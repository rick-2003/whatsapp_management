    ...
    <>      <Helmet>
        ...
        <div className="max-w-2xl mx-auto pt-8">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-6 text-white mb-6">
            <h2 className="text-xl font-bold mb-2">Our Admin Team</h2>
            <p className="text-blue-100 text-sm">
              Our dedicated team of administrators is here to help you with community groups, 
              technical support, and business networking opportunities.
            </p>
          </div>          {/* Admin Cards */}
            ...
            {admins.map((admin) => (
              <div key={admin.id} className="bg-white rounded-2xl shadow-xl p-6">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm">{admin.bio}</p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl p-4 flex items-center justify-center space-x-3 hover:from-green-600 hover:to-green-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                  >
